...
> Phiên bản: **2026-06-13** · Môi trường: **Load-test 3 node, DigitalOcean SGP1**
...
### 2.1. Sơ đồ tổng thể (3 lớp: Internet → Edge → Backend)
...
```
 ...
 │                  ▼                                        ▼                           │
 │  ┌─ NODE B — crm-db (10.104.0.3 / 165.232.173.192) ──┐  ┌─ NODE C — crm-loadtest ──┐ │
 │  │  MongoDB rs0   bind 127.0.0.1,10.104.0.3:27017     │  │  (10.104.0.4 / 159.89...)│ │
...
### Node C — crm-loadtest (`10.104.0.4` / `159.89.199.112`)
...
#     prometheus truy cập qua SSH tunnel: ssh -L 9090:127.0.0.1:9090 deploy@159.89.199.112
...
| Cổng | Node A | Node B | Node C |
|---|---|---|---|
| 22 SSH | public | public | public |
| 80/443 | public | — | — |
| 3000 app | VPC | — | — |
| 27017 Mongo | — | VPC | — |
| 6379 Redis | — | VPC | — |
...
### 7.3. Node C — crm-loadtest (`10.104.0.4`)

**Vai trò:** Load generator + Observability hub. Toàn bộ qua docker compose (`/home/deploy/crm-test/docker-compose.test.yml`).
